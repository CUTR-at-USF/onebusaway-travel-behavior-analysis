...
* **OBA data file** - A csv file generated by [OBA firebase export](https://github.com/CUTR-at-USF/onebusaway-firebase-export).
* **Ground truth data** - A xlsx file that must be formatted as shown below. The main column descriptions are:
